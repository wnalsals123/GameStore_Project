        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col p-2 border-2 rounded-lg border-neutral-100">
            ...
            <div className="flex my-2 border-b-[1px] pb-2 flex-wrap flex-col xsm:flex-row">
              ...
              <span>1000exp</span>
              <SpanTextHighlight className={'ml-2 text-[0.6rem] xsm:text-sm sm:text-base'} str={`*달성 시 "실버"로 상승`} highlightText={'실버'} highlightColor={'text-sky-500'}></SpanTextHighlight>
            </div>
            <div className="flex my-2 border-b-[1px] pb-2 flex-wrap flex-col xsm:flex-row">
              ...
              <SpanTextHighlight className={'ml-2 text-[0.6rem] xsm:text-sm sm:text-base'} str={`*구매 금액의 "1%" 적립`} highlightText={'1%'} highlightColor={'text-sky-500'}></SpanTextHighlight>
            </div>
